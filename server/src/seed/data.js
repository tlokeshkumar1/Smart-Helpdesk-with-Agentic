export const users = [
  ...
  { name: 'Bob Agent', email: 'agent@example.com', password: 'agent123', role: 'agent' },
  { name: 'Uma User', email: 'user@example.com', password: 'user123', role: 'user' }
];
...
export const tickets = [
  { title: 'Refund for double charge', description: 'I was charged twice for order #1234. The first charge was on Dec 15th and the second on Dec 16th. Please help me get a refund for one of these charges.', category: 'billing' },
  { title: 'App shows 500 error on login', description: 'Every time I try to log into the mobile app, I get a 500 internal server error. Stack trace mentions auth module timeout. This started happening yesterday.', category: 'tech' },
  { title: 'Where is my package?', description: 'My shipment was supposed to arrive 5 days ago but tracking still shows "in transit". Order number is #ORD-5678. Can you check what happened?', category: 'shipping' },
  { title: 'Cannot reset password', description: 'I\'ve tried multiple times to reset my password but I\'m not receiving the reset email. I\'ve checked spam folder too. My email is john@example.com', category: 'other' },
  { title: 'API returning 429 errors', description: 'Our integration is getting 429 rate limit errors even though we\'re only making 500 requests per hour. We\'re on the standard plan. Is there an issue?', category: 'tech' },
  { title: 'How to update payment method?', description: 'I want to change my payment method for future billing. How can I do this?', category: 'billing' }
];
